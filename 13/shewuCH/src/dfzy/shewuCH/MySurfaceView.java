...
class MySurfaceView extends GLSurfaceView {
    ...
    {   
    	jinzita[] pArray;//金字塔数组
    	shamo desert;//沙漠
    	xingkong celestialSmall;//小星星星空半球
    	xingkong celestialBig;//大星星星空半球
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            pArray=new jinzita[]
	        {
	    			new jinzita(-2,-2,2.0f,30,wallaId),
	    			new jinzita(3,-7,2.0f,0,wallbId),
	    			new jinzita(6,-2,2.0f,0,wallcId),
	        };
            //创建沙漠
            desert=new shamo(-20,-20,4,0,desertId,40,40);
            //创建星空
            celestialSmall=new xingkong(0,0,1,0,250);
            celestialBig=new xingkong(0,0,2,0,50);
