...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    {   
		public int bodyTextureId;//纹理名称ID
		public int circleTextureId;
		PackageDrum cylinder;
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            bodyTextureId=initTexture(gl,R.drawable.hong);//纹理ID
            circleTextureId=initTexture(gl,R.drawable.huang);       
            cylinder=new PackageDrum(MyGLSurfaceView.this);
//            //开启一个线程自动旋转光源
//            new Thread()
//            {
//          	  public void run()
