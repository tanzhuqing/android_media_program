...
public class MyGLSurfaceView extends GLSurfaceView {
    ...
    {   
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            textureId=initTexture(gl,R.drawable.line2);//纹理ID
            cylinder=new Drawluo(2f,10f,textureId);//创建螺旋面
...
//          		  {
//          			lightAngle+=5;//转动灯
//          			mRenderer.cylinder.mAngleY+=5*TOUCH_SCALE_FACTOR;//球沿Y轴转动
//                    requestRender();//重绘画面
//                    try
//                    {
